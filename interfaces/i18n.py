...
_T: dict[str, dict[str, str]] = {
    ...
    "usage_permissions": {"en": "Usage: /permissions [default|full|full confirm]", "pt": "Uso: /permissions [default|full|full confirm]", "es": "Uso: /permissions [default|full|full confirm]"},
    "voice_enabled": {"en": "Voice mode enabled. I'll respond by voice from now on.", "pt": "Modo de voz ativado. Vou responder por voz a partir de agora.", "es": "Modo de voz activado. Responderé por voz a partir de ahora."},
    "voice_disabled": {"en": "Voice mode disabled. I'll respond in text only.", "pt": "Modo de voz desativado. Vou responder apenas em texto.", "es": "Modo de voz desactivado. Responderé solo con texto."},
    "voice_status_on": {"en": "Voice mode is on.", "pt": "O modo de voz está ativado.", "es": "El modo de voz está activado."},
    "voice_status_off": {"en": "Voice mode is off.", "pt": "O modo de voz está desativado.", "es": "El modo de voz está desactivado."},
    "voice_task_complete": {"en": "Task complete.", "pt": "Tarefa concluída.", "es": "Tarea completada."},
    "permissions_status_default": {"en": "Permission level: Default\nDestructive commands require approval.", "pt": "Nível de permissão: Padrão\nComandos destrutivos exigem aprovação.", "es": "Nivel de permisos: Predeterminado\nLos comandos destructivos requieren aprobación."},
    "permissions_status_full": {"en": "Permission level: Full Access\nDestructive commands run without approval.", "pt": "Nível de permissão: Acesso Total\nComandos destrutivos executam sem aprovação.", "es": "Nivel de permisos: Acceso Total\nLos comandos destructivos se ejecutan sin aprobación."},
    "permissions_set_default": {"en": "Permission level set to Default.", "pt": "Nível de permissão definido como Padrão.", "es": "Nivel de permisos ajustado a Predeterminado."},
    "permissions_confirm_full": {"en": "Full Access is high risk. Send `/permissions full confirm` to continue.", "pt": "Acesso Total tem risco elevado. Envie `/permissions full confirm` para continuar.", "es": "Acceso Total es de alto riesgo. Envíe `/permissions full confirm` para continuar."},
    "permissions_set_full": {"en": "Permission level set to Full Access.", "pt": "Nível de permissão definido como Acesso Total.", "es": "Nivel de permisos ajustado a Acceso Total."},
    "config_open_instructions": {"en": "Open this file locally to edit your profile:\n{path}", "pt": "Abra este arquivo localmente para editar seu perfil:\n{path}", "es": "Abra este archivo localmente para editar su perfil:\n{path}"},
    "patterns_empty": {"en": "No patterns learned yet. Keep using Gedos!", "pt": "Nenhum padrão aprendido ainda. Continue usando o Gedos!", "es": "Aún no se aprendieron patrones. Siga usando Gedos."},
    "patterns_header": {"en": "🧠 Learned patterns ({n}):", "pt": "🧠 Padrões aprendidos ({n}):", "es": "🧠 Patrones aprendidos ({n}):"},
    "patterns_item": {"en": "{n}. [{confidence}%] {trigger} → {action}", "pt": "{n}. [{confidence}%] {trigger} → {action}", "es": "{n}. [{confidence}%] {trigger} → {action}"},
    "pattern_trigger_time": {"en": "Every {day} ~{time}", "pt": "Toda {day} ~{time}", "es": "Cada {day} ~{time}"},
    "pattern_trigger_after": {"en": "After {trigger}", "pt": "Depois de {trigger}", "es": "Después de {trigger}"},
    "pattern_trigger_app": {"en": "While in {trigger}", "pt": "Ao usar {trigger}", "es": "Mientras usa {trigger}"},
    "pattern_not_found": {"en": "❌ Pattern #{id} not found.", "pt": "❌ Padrão #{id} não encontrado.", "es": "❌ Patrón #{id} no encontrado."},
    "pattern_removed": {"en": "🗑️ Pattern #{id} removed.", "pt": "🗑️ Padrão #{id} removido.", "es": "🗑️ Patrón #{id} eliminado."},
    "pattern_confirmed": {"en": "💡 I noticed a pattern:\n{trigger} → you usually {action}.\nWant me to automate this?\n[✅ Yes, always] [❌ No] [🔕 Never suggest this]\nUse /yes, /no, or /never.", "pt": "💡 Notei um padrão:\n{trigger} → você geralmente faz {action}.\nQuer que eu automatize isso?\n[✅ Sim, sempre] [❌ Não] [🔕 Nunca sugerir]\nUse /yes, /no ou /never.", "es": "💡 Noté un patrón:\n{trigger} → normalmente hace {action}.\n¿Quiere que lo automatice?\n[✅ Sí, siempre] [❌ No] [🔕 No volver a sugerir]\nUse /yes, /no o /never."},
    "pattern_automation_enabled": {"en": "✅ Pattern automation enabled for: {action}", "pt": "✅ Automação de padrão ativada para: {action}", "es": "✅ Automatización del patrón activada para: {action}"},
    "pattern_automation_declined": {"en": "Okay, I won't automate this pattern.", "pt": "Certo, não vou automatizar esse padrão.", "es": "De acuerdo, no automatizaré este patrón."},
    "pattern_suppressed": {"en": "🔕 Pattern suppressed. I won't suggest it again.", "pt": "🔕 Padrão silenciado. Não vou sugeri-lo novamente.", "es": "🔕 Patrón silenciado. No volveré a sugerirlo."},
    "usage_owner": {"en": "Usage: /owner status|allow <chat_id>|revoke <chat_id>", "pt": "Uso: /owner status|allow <chat_id>|revoke <chat_id>", "es": "Uso: /owner status|allow <chat_id>|revoke <chat_id>"},
    ...
    "dry_run_plan": {"en": "📋 Plan ({n} steps):\n{steps}\n\n[▶️ Run] [❌ Cancel]", "pt": "📋 Plano ({n} passos):\n{steps}\n\n[▶️ Run] [❌ Cancelar]", "es": "📋 Plan ({n} pasos):\n{steps}\n\n[▶️ Ejecutar] [❌ Cancelar]"},
    "dry_run_countdown": {"en": "Running in {seconds}s... /stop to cancel", "pt": "Executando em {seconds}s... /stop para cancelar", "es": "Ejecutando en {seconds}s... /stop para cancelar"},
    "dry_run_cancelled": {"en": "❌ Plan cancelled.", "pt": "❌ Plano cancelado.", "es": "❌ Plan cancelado."},
    ...
    "task_stopped": {"en": "⛔ Stopped.", "pt": "⛔ Parado.", "es": "⛔ Detenido."},
    ...
    "copilot_hint_pattern": {"en": "💡 You usually {action} at this time. Want me to?", "pt": "💡 Você costuma {action} neste momento. Quer que eu faça isso?", "es": "💡 Normalmente {action} en este momento. ¿Quiere que lo haga?"},
    ...
    "forget_cleared": {"en": "🗑️ All learned patterns cleared.", "pt": "🗑️ Todos os padrões aprendidos foram apagados.", "es": "🗑️ Todos los patrones aprendidos fueron borrados."},
    ...
    "private_bot": {"en": "This is a private bot.", "pt": "Este bot é privado.", "es": "Este bot es privado."},
    "pairing_required": {"en": "Pairing code required on first /start.", "pt": "Código de pareamento obrigatório no primeiro /start.", "es": "Código de emparejamiento obligatorio en el primer /start."},
    "owner_status": {"en": "Owner chat: {owner}\nAllowed: {allowed}", "pt": "Chat do dono: {owner}\nPermitidos: {allowed}", "es": "Chat del propietario: {owner}\nPermitidos: {allowed}"},
    "owner_allowed": {"en": "Allowed chat added: {chat_id}", "pt": "Chat permitido adicionado: {chat_id}", "es": "Chat permitido agregado: {chat_id}"},
    "owner_revoked": {"en": "Allowed chat revoked: {chat_id}", "pt": "Chat permitido removido: {chat_id}", "es": "Chat permitido revocado: {chat_id}"},
    "destructive_confirm": {"en": "⚠️ This action modifies your system:\n{command}\n[✅ Allow once] [📋 Whitelist] [❌ Deny]", "pt": "⚠️ Esta ação modifica seu sistema:\n{command}\n[✅ Permitir uma vez] [📋 Whitelist] [❌ Negar]", "es": "⚠️ Esta acción modifica su sistema:\n{command}\n[✅ Permitir una vez] [📋 Lista blanca] [❌ Denegar]"},
    "destructive_denied": {"en": "❌ Destructive command denied.", "pt": "❌ Comando destrutivo negado.", "es": "❌ Comando destructivo denegado."},
